...
class AlpheiosLemmaTranslationsAdapter {
  ...
  fetchWindow (url) {
    return new promise_polyfill__WEBPACK_IMPORTED_MODULE_2__["default"]((resolve, reject) => {
      window.fetch(url, {
        method: 'GET',
        headers: {
